...
contains(USE_UPNP, -) {
    ...
    DEFINES += USE_UPNP=$$USE_UPNP MINIUPNP_STATTHRXLIB STATTHRXLIB
...
windows:!contains(MINGW_THREAD_BUGFIX, 0) {
    ...
    DEFINES += _MT BOOST_THREAD_PROVIDES_GENERTHRX_SHARED_MUTEX_ON_WIN
...
macx:THRXON = src/qt/res/icons/Therris.icns
macx:TARGET = "Therris-Qt"
