...
const QString BITCOIN_IPC_PREFIX("Therris:");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Therris: click-to-pay handler");
    else
        connect(uriServer, SIGNAL(newConnection()), this, SLOT(handleURTHRXonnection()));
}
...
void PaymentServer::handleURTHRXonnection()
{
