...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeTherrisAmount"))
        settings.setValue("nAnonymizeTherrisAmount", 1000);
    nAnonymizeTherrisAmount = settings.value("nAnonymizeTherrisAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeTherrisAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeTherrisAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeTherrisAmount:
            return QVariant(nAnonymizeTherrisAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeTherrisAmount:
            nAnonymizeTherrisAmount = value.toInt();
            settings.setValue("nAnonymizeTherrisAmount", nAnonymizeTherrisAmount);
            emit AnonymizeTherrisAmountChanged(nAnonymizeTherrisAmount);
            break;
        default:
            break;
        }
