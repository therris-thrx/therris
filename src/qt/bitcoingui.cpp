...
{
    resize(900, 520);
    setWindowTitle(tr("Therris") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Therris");
    setStyleSheet("#Therris { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Therris address"));
    ...
    aboutAction = new QAction(QIcon(":icons/therris"), tr("&About Therris"), this);
    aboutAction->setToolTip(tr("Show information about Therris"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Therris"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit Therris.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for Therris"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit Therris.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for Therris (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where Therris data is stored"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Therris client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Therris client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSBAR_THRXONSIZE,STATUSBAR_THRXONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Therris network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if(secs < 90*60)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(fUseBlackTheme ? ":/icons/black/synced" : ":/icons/synced").pixmap(STATUSBAR_THRXONSIZE, STATUSBAR_THRXONSIZE));
...
void BitcoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    ...
    if (style & CClientUIInterface::THRXON_ERROR) {
        nMBoxIcon = QMessageBox::Critical;
        nNotifyIcon = Notificator::Critical;
    }
    else if (style & CClientUIInterface::THRXON_WARNING) {
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Therris address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    {
    labelEncryptionIcon->setPixmap(QIcon(fUseBlackTheme ? ":/icons/black/lock_open" : ":/icons/lock_open").pixmap(STATUSBAR_THRXONSIZE,STATUSBAR_THRXONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->setPixmap(QIcon(fUseBlackTheme ? ":/icons/black/lock_closed" : ":/icons/lock_closed").pixmap(STATUSBAR_THRXONSIZE,STATUSBAR_THRXONSIZE));
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    nEstimateTime = TARGET_SPACING * nNetworkWeight / nWeight;
        ...
        labelStakingIcon->setPixmap(QIcon(fUseBlackTheme ? ":/icons/black/staking_on" : ":/icons/staking_on").pixmap(STATUSBAR_THRXONSIZE,STATUSBAR_THRXONSIZE));
        labelStakingIcon->setToolTip(tr("Staking.<br>Your weight is %1<br>Network weight is %2<br>Expected time to earn reward is %3").arg(nWeight).arg(nNetworkWeight).arg(text));
    }
    else
    {
        labelStakingIcon->setPixmap(QIcon(fUseBlackTheme ? ":/icons/black/staking_off" : ":/icons/staking_off").pixmap(STATUSBAR_THRXONSIZE,STATUSBAR_THRXONSIZE));
