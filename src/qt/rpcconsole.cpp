...
const QSize THRXON_SIZE(24, 24);

const int INITIAL_TRAFFTHRX_GRAPH_MINS = 30;
...
/**
 * Split Therris command line into a list of arguments. Aims to emulate \c bash and friends.
 *
    ...
    banTableContextMenu(0)
{
    ...
    startExecutor();
    setTrafficGraphRange(INITIAL_TRAFFTHRX_GRAPH_MINS);
...
void RPCConsole::clear()
{
    ...
    for(int i=0; THRXON_MAPPING[i].url; ++i)
    {
        ui->messagesWidget->document()->addResource(
                    QTextDocument::ImageResource,
                    QUrl(THRXON_MAPPING[i].url),
                    QImage(THRXON_MAPPING[i].source).scaled(THRXON_SIZE, Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
    }
    ...
    message(CMD_REPLY, (tr("Welcome to the Therris RPC console.") + "<br>" +
