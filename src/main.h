...
static const int64_t STATTHRX_POS_REWARD = 1 * COIN; //Constant reward of 3.4 NTR per block has been ignored
static const int64_t TARGET_SPACING = 1 * 60; // 2 min per Block
...
static const int64_t MAX_MONEY = 100000000000 * COIN; // 5M PoW coins
