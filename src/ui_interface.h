...
public:
    ...
    enum MessageBoxFlags
    {
         ...
         */
        THRXON_MASK = (THRXON_INFORMATION | THRXON_WARNING | THRXON_ERROR),
        ...
        MSG_INFORMATION = (THRXON_INFORMATION | BTN_OK),
        MSG_WARNING = (THRXON_WARNING | BTN_OK | MODAL),
        MSG_ERROR = (THRXON_ERROR | BTN_OK | MODAL)
    };
