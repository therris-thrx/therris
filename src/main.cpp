...
const string strMessageMagic = "Therris Signed Message:\n";
                        ...
                        bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees, bool fFixSpentCoins)
{
...

    {
        ...
        // instance the STRTHRXTENC flag was incorrectly allowing certain
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t nSubsidy = STATTHRX_POS_REWARD;
