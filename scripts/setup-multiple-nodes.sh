...
./therrisd --datadir=./node1 &
./therrisd --datadir=./node2 &
./therrisd --datadir=./node3 &
./therrisd --datadir=./node4 &
./therrisd --datadir=./node5 &
./therrisd --datadir=./node6 &
./therrisd --datadir=./node7 &
