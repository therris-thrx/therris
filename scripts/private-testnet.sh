...
./therrisd --datadir=./test1 &
./therrisd --datadir=./test2 &
./therrisd --datadir=./test3 &
./therrisd --datadir=./test4 &
./therrisd --datadir=./test5 &
./therrisd --datadir=./test6 &
./therrisd --datadir=./test7 &
